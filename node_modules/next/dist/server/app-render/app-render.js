...
async function spawnDynamicValidationInDev(resolveValidation, tree, ctx, isNotFound, clientReferenceManifest, route) {
    ...
    let reactServerStream = await _workunitasyncstorageexternal.workUnitAsyncStorage.run(firstAttemptServerPrerenderStore, ComponentMod.renderToReadableStream, firstAttemptRSCPayload, clientReferenceManifest.clientModules, {
        ...
        try {
            await (0, _apprenderprerenderutils.prerenderAndAbortInSequentialTasks)(async ()=>{
                _workunitasyncstorageexternal.workUnitAsyncStorage.run(secondAttemptClientPrerenderStore, prerender, /*#__PURE__*/ (0, _jsxruntime.jsx)(App, {
                    ...
                    onError: (err, errorInfo)=>{
                        if ((0, _dynamicrendering.isPrerenderInterruptedError)(err) || secondAttemptClientController.signal.aborted) {
                            const componentStack = errorInfo.componentStack;
                            if (typeof componentStack === 'string' && err instanceof Error) {
                                (0, _dynamicrendering.trackAllowedDynamicAccess)(route, componentStack, dynamicValidation, serverDynamicTracking, clientDynamicTracking);
                            }
...
async function prerenderToStream(req, res, ctx, metadata, workStore, tree) {
    ...
    try {
         ...
         */ const cache = workStore.incrementalCache;
                ...
                metadata.flightData = await (0, _nodewebstreamshelper.streamToBuffer)(serverPrerenderStreamResult.asStream());
                const getServerInsertedHTML = (0, _makegetserverinsertedhtml.makeGetServerInsertedHTML)({
                    polyfills,
                    renderServerInsertedHTML,
                    serverCapturedErrors: allCapturedErrors,
