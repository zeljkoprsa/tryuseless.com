        ...
        if (this.nextConfig.experimental.dynamicIO) {
            ...
            responseGenerator = async (state)=>{
                if (this.renderOpts.dev) {
                    ...
                    if (!isPrefetchRSCRequest && (routeModule == null ? void 0 : routeModule.definition.kind) === _routekind.RouteKind.APP_PAGE && !isServerAction) {
                    ...
                    const response = (0, _cachescopeexternal.runWithCacheScope)({
                        cache
