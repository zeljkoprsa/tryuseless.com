...
function generateCacheEntry(workStore, outerWorkUnitStore, cacheScope, clientReferenceManifest, encodedArguments, fn) {
    ...
    return runInCleanSnapshot(generateCacheEntryWithRestoredWorkStore, workStore, outerWorkUnitStore, cacheScope, clientReferenceManifest, encodedArguments, fn);
}
function generateCacheEntryWithRestoredWorkStore(workStore, outerWorkUnitStore, cacheScope, clientReferenceManifest, encodedArguments, fn) {
    ...
    if (cacheScope) {
        return cacheScopeAsyncLocalStorage.run(cacheScope, ()=>workAsyncStorage.run(workStore, generateCacheEntryWithCacheContext, workStore, outerWorkUnitStore, clientReferenceManifest, encodedArguments, fn));
    }
